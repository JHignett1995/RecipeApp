...
public class RecipeDBRepository implements RecipeRepository {
	...
	public String createRecipe(String recipe) {
		...
		return "{\"message\": \"recipe has been added like a boss\"}";
	}
	...
	public String deleteRecipe(Long id) {
		...
		return "{\"message\": \"recipe sucessfully deleted, tasted like S#1T\"}";
	}
	...
	public int cycleRecipes(String recipe) {
		...
		List<Recipe> validList = recipes.stream().filter(n -> n.getRecipeName().equals(recipe)).collect(Collectors.toList());
